...
# Add ingress rule to Aurora security group to allow Lambda access
resource "aws_security_group_rule" "aurora_allow_lambda" {
  ...
  description              = "Allow Lambda function to connect to Aurora PostgreSQL for VA configuration"
}
